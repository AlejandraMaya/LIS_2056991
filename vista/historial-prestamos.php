            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <strong class="card-title">Historial de préstamos</strong>
                </div>
                          ...
                          <table class="table table-striped table-hover" id="libros">
                            ...
                            <thead>
                              <tr>
                                ...
                                <th>N° préstamo</th>
                                <th>Estado</th>   
                                <th><button type="button" onclick="location.href='registrar-pres.php'" class="btn btn-success btn-sm">Ver detalle</button></th>  
