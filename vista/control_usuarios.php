  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn" id="boton_eliminar" name="eliminar_usuario"><li class="fas fa-times"></li> Eliminar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="" id="frmEditar" action="../controlador/editar.php" method="post">
          ...
          <input type="text" hidden="" class="form-control" id="id_usuario" name="id_usuario" ><br>

          <div class="form-row">            
            <div class="col">
              <label for="nombre_usuario">Nombre de usuario</label>
              <input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" placeholder="Editar nombre" required="" required="" minlength="3" maxlength="30" pattern="[A-Za-z]+" title="Solo se permiten letras"><br>
            </div>

            <div class="col">
              <label for="apellido_usuario">Apellidos de usuario</label>
            <input type="text" class="form-control" id="apellido_usuario" name="apellido_usuario" placeholder="Editar apellidos" required="" minlength="3" maxlength="30" pattern="[A-Za-z]+" title="Solo se permiten letras"><br>
          </div>
        </div>
          ...
          <div class="form-row">            
            ...
            <input type="email"  class="form-control" id="correo_usuario" name="correo_usuario" placeholder="Editar correo" required="" maxlength="50"><br>
          </div>

          <div class="col"> 
          <label for="telefono_usuario">Teléfono de usuario</label>
            <input type="number" class="form-control" id="telefono_usuario" name="telefono_usuario" placeholder="Editar Teléfono" required="" minlength="5" maxlength="15" title="Solo se permiten números" pattern="[0-9]+"><br>
          </div>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn" data-dismiss="modal" id="boton_cerrar">Cerrar</button>
        <button type="submit" class="btn" name="editar_usuario" id="boton_editar"><li class="fas fa-check"></li> Guardar cambios</button>
      </div>
    </div>
  </div>
</div>
...
<button type="button" class="btn" data-toggle="modal" data-target="#modalAgregar" id="boton_agregar"><li class="far fa-plus-square"></li> Agregar usuario
</button>
    ...
    var listar =function(){
      ...
      var table = $('#usuarios').DataTable({
        ...
        "ajax":{
          ...
          "method":"POST",
          "url":"../controlador/traer_datos_usuarios.php"
      ...
      obtener_id_eliminar("#usuarios tbody", table);
        ...
        var obtener_data_editar=function(tbody, table){
          ...
          $(tbody).on("click","button.editar", function(){
            ...
            var id_usuario=$("#frmEditar #id_usuario").val(data.id_usuario),
              nombre_usuario=$("#frmEditar #nombre_usuario").val(data.nombre_usuario),
              apellido_usuario=$("#frmEditar #apellido_usuario").val(data.apellido_usuario),
              correo_usuario=$("#frmEditar #correo_usuario").val(data.correo_usuario),
              telefono_usuario=$("#frmEditar #telefono_usuario").val(data.telefono_usuario);
        ...
        var obtener_id_eliminar=function(tbody, table){
          ...
          $(tbody).on("click","button.eliminar", function(){
            ...
            var id_usuario=$("#frmEliminar #id_usuario").val(data.id_usuario);
