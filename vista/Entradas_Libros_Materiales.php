                                    ...
                                    <div class="col-lg-12">
                                        <div class="table-responsive table-sm" id="c_tabla">
                                            <table class="table table-striped table-hover" id="libros">
                                                ...
                                                <button type="button" class="btn" onclick="location.href='Registrar_Entrada.php'" id="boton_agregar">
                                                    <li class="far fa-plus-square"></li> Agregar Entrada
                                                </button>

                                                <thead>
                                                    <tr>
                                                        <th>Tipo</th>
                                                        <th>Titulo Libro O Material</th>
                                                        <th>Fecha Entrada</th>
                                                        <th>Estado</th>
                                                    </tr>
                                                </thead>
