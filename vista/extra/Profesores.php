            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <strong class="card-title">Usuario/Profesores</strong>
                </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="table-responsive table-sm" id="c_tabla">
                          ...
                          <button type="button" class="btn" data-toggle="modal" data-target="#modalAgregar-usuario" id="boton_agregar"><li class="far fa-plus-square"></li> Agregar Profesor</button>
                            <thead>
                              <tr>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="modal-title"><h5 id="titulo_agregar"><li class="fas fa-plus-circle"></li> Agregar Profesor<h5></div>
