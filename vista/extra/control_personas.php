                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-bar-chart-o"></i><a href="extra_emple.php">Información</a></li>
...
<input type="hidden" name="num_persona" id="num_persona" value="">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <b>¿Estás seguro que deseas eliminar a esta persona?</b>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn" data-dismiss="modal" id="boton_cerrar">Cerrar</button>
        <button type="submit" class="btn" id="boton_eliminar" name="eliminar_persona"><li class="fas fa-times"></li> Eliminar</button>
      </div>
    </div>
  </div>
</div>
        ...
        <form class="" id="frmAgregar" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
          ...
          <div class="form-row">            
            <div class="col">
              ...
              <input type="text" class="form-control" id="identificacion" name="identificacion" placeholder="Insertar Documento" required="" minlength="6" maxlength="15" title="Solo se permiten números" pattern="[0-9]+"><br>
            </div>

            <div class="col">
              <label for="nombre">Nombre</label>
            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Insertar nombre" required="" minlength="3" maxlength="30"><br>
          </div>
        </div>
          ...
          <div class="form-row">            
            ...
            <input type="text"  class="form-control" id="direccion" name="direccion" placeholder="Insertar dirección" maxlength="30"><br>
          </div>
        </div>
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditarCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <div class="modal-title"><h5 id="titulo_editar"><li class="fas fa-pencil-alt"></li> Editar Usuario</h5></div>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        ...
        <form class="" id="frmEditar" action="../controlador/editar.php" method="post">
          ...
          <input type="text" hidden="" class="form-control" id="num_persona" name="num_persona" ><br>

          <div class="form-row">            
            <div class="col">
              <label for="identificacion">Documento</label>
              <input type="number" class="form-control" id="identificacion" name="identificacion" placeholder="Editar identificación" required="" minlength="6" maxlength="15" title="Solo se permiten números" pattern="[0-9]+"><br>
            </div>

            <div class="col">
              <label for="nombre">Nombre</label>
            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Editar nombre" required="" minlength="3" maxlength="30"><br>
          </div>
        </div>
          ...
          <div class="form-row">            
            <div class="col">       
              <label for="apellidos">Apellidos</label>  
            <input type="text"  class="form-control" id="apellidos" name="apellidos" placeholder="Editar apellidos" required="" minlength="3" maxlength="30"><br>
          </div>

          <div class="col"> 
          <label for="telefono">Teléfono</label>
            <input type="number" class="form-control" id="telefono" name="telefono" placeholder="Editar Teléfono" required="" minlength="5" maxlength="15" title="Solo se permiten números" pattern="[0-9]+"><br>
          </div>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn" data-dismiss="modal" id="boton_cerrar">Cerrar</button>
        <button type="submit" class="btn" name="editar_persona" id="boton_editar"><li class="fas fa-check"></li> Guardar cambios</button>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="row" >
            <div class="">
                <div class="table-responsive table-sm" id="c_tabla">
                    <table class="table table-striped table-hover" id="personas">
<!-- Button trigger modal -->
<button type="button" class="btn" data-toggle="modal" data-target="#modalAgregar" id="boton_agregar"><li class="far fa-plus-square"></li> Agregar persona
</button>
    ...
    var listar =function(){
      ...
      var table = $('#personas').DataTable({
        ...
        "ajax":{
          ...
          "method":"POST",
          "url":"../controlador/traer_datos_personas.php"
      ...
      obtener_data_editar("#personas tbody", table);
      obtener_id_eliminar("#personas tbody", table);
        ...
        var obtener_data_editar=function(tbody, table){
          ...
          $(tbody).on("click","button.editar", function(){
            ...
            var num_persona=$("#frmEditar #num_persona").val(data.num_persona),
              identificacion=$("#frmEditar #identificacion").val(data.identificacion),
        ...
        var obtener_id_eliminar=function(tbody, table){
          ...
          $(tbody).on("click","button.eliminar", function(){
            ...
            var num_persona=$("#frmEliminar #num_persona").val(data.num_persona);
